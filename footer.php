        ...
        <footer>
         ...
         <div class="bloc-12 copyright">
                ...
                <p>  
                    ...
                    <?php $plxShow->lang('IN') ?> <?php $plxShow->chrono(); ?> utilisant la technologie <a href="https://github.com/psd-html/Framework-responsive-PluXml">SASS</a>   <a rel="nofollow" href="<?php $plxShow->urlRewrite('core/admin/'); ?>" title="<?php $plxShow->lang('ADMINISTRATION') ?>"><span class="symbol">X</span></a><a href="<?php $plxShow->urlRewrite('#top') ?>" title="<?php $plxShow->lang('GOTO_TOP') ?>"><?php $plxShow->lang('TOP') ?> </a><?php $plxShow->httpEncoding() ?>  <span class="symbol">.</span><a href="http://validator.w3.org/check?uri=referer">W3C</a>
                </p>
